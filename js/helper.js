...
var HTMLwelcomeMsg = '<div class="flex-header"><h3 id="about-me" class="orange-text">A little about me...</h4><span class="welcome-message">%data%</h3></div>';
...
var HTMLprojectStart = '<div class="project-entry flex-item-project"></div>';
...
var HTMLschoolName = '<a href="%url%" target="_blank"><div>%data%</div></a>';
var HTMLschoolDegree = '<br/><b>%data%</b>';
